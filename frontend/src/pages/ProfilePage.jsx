...
const ProfilePage = ({ setCurrentPage }) => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            console.log('📦 Дархост барои фармоишҳо...');
            console.log('   Token:', token ? 'Ҳаст' : 'Нест');
            ...
            if (!res.ok) {
                ...
                console.error('❌ Хато аз сервер:', text);
                throw new Error(`HTTP ${res.status}: ${text}`);
            }

            const data = await res.json();
            console.log('✅ Маълумот гирифта шуд:', data);

            if (data.success && Array.isArray(data.orders)) {
                setOrders(data.orders);
                console.log(`✅ ${data.orders.length} фармоиш ёфт шуд`);
            } else {
                console.warn('⚠️ Format нодуруст:', data);
                setOrders([]);
            }
        } catch (err) {
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <button
                        ...
                        onClick={() => alert('Таҳрири профил дар версияи минбаъда!')}
                    >
                        Таҳрири профил
                    </button>
                </div>
                        ...
                        <div className="space-y-4">
                            {orders.map(order => (
                                <div
                                    ...
                                    onClick={() => {
                                        console.log('Фармоиши интихобшуда:', order);
                                        setCurrentPage('order-detail'); // Агар саҳифаи тафсилот дошта бошед
                                    }}
                                >
                                    ...
                                    <div className="border-t pt-4">
                                        <p className="text-sm text-gray-600 mb-2">
                                            Маҳсулот: {order.items?.length || 0} дона
                                        </p>
...
//                         onClick={() => setCurrentPage('edit-profile')} // агар page edit дошта бошӣ
//                     >
//                         Таҳрири профил
//                     </button>
//                 </div>
...
//                 {/* Orders */}
//                 <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-lg">
//                     <h2 className="text-2xl font-bold mb-6">Фармоишҳои ман</h2>
//
//                     {loadingOrders ? (
//                         <p className="text-center text-gray-500">⏳ Бор шуда истодааст...</p>
//                     ) : orders.length === 0 ? (
//                         <div className="text-center py-12 text-gray-500">
//                             <Package className="w-16 h-16 mx-auto mb-4 text-gray-300" />
//                             <p>Шумо ҳоло фармоиш надоред</p>
//                             <button
//                                 onClick={() => setCurrentPage('products')}
...
//                                     </div>
//                                     <div className="text-right">
//                                         <p className="font-bold text-purple-600">{order.totalPrice} сомонӣ</p>

...
//                         }`}
//                     >
//                         <div className={`bg-gradient-to-r ${slide.gradient} h-full p-12 text-white flex items-center`}>
...
//                                     className="bg-white text-gray-800 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition animate-fade-in-delay-2"
//                                 >
//                                     {slide.buttonText}
//                                 </button>
//                             </div>
...
//             <button
//                 onClick={prevSlide}
//                 className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white p-2 rounded-full transition"
//             >
...
//             <button
//                 onClick={nextSlide}
//                 className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white p-2 rounded-full transition"
//             >
...
//             <button
//                 onClick={prevSlide}
//                 className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white p-2 rounded-full transition z-10"
//             >
//                 <ChevronLeft className="w-6 h-6" />
//             </button>
//
//             <button
//                 onClick={nextSlide}
//                 className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 backdrop-blur-sm text-white p-2 rounded-full transition z-10"
//             >
//                 <ChevronRight className="w-6 h-6" />
//             </button>
//
